...
class ImpedanceControllerPolicy:
    ...
    def log_to_buffers(ft_pos_goal_list, ft_vel_goal_list, 
                       cur_ft_pos, obj_pose, torque, obj_pose_des,
        ...
        if self.x_traj is None:
            ...
            self.l_desired_obj_pose.append(obj_pose_des)
    ...
    def predict(self, full_observation):
        ...
        torque = c_utils.impedance_controller(ft_pos_goal_list,
                                              ...
                                              ft_des_force_wf=ft_des_force_wf,
                                              Kp = KP, Kv = KV)
